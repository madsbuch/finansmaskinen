...
section { box-sizing: border-box; height: 11in; margin: 0 auto; margin-bottom: 0.5in; overflow: hidden; padding: 0.5in; width: 8.5in; }
		...
		<section>
			...
			<article>
				...
				<address>
					...
					?><br /><br /><?php echo 
					$customer->PartyLegalEntity->CompanyID->schemeID
					.' '.
