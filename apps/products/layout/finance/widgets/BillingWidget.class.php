...
class BillingWidget extends \helper\layout\LayoutBlock implements \helper\layout\Widget{
	...
	function generate(){
		...
		<div class="alert alert-info">Denne Regning er endnu ikke reflekteret i dit varelager</div>'));
