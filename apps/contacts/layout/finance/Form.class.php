...
<form method="post" action="/contacts/'.($this->c ? 'update' : 'create').'">
	...
	<div class="row">
		<div class="span6">
			...
			<div>
				<label>Navn:</label>
				<input name="Party-PartyName" type="text" class="span6"
					title="Navn på virksomheden eller personen"
					id="Party-PartyName" required="required" />
				...
				<input name="legalNumbers-DKCVR" type="text" class="span6"
				...
				<input name="legalNumbers-DKEAN" type="text" class="span6"
			...
			<h2>Indstillinger</h2>
			<div class="well">
				<input name="contactID" id="contactID" type="text" class="span5" placeholder="Unikt kundeid"
					title="Kundeid"
		...
		<div class="offset1 span5">
			...
			<div id="contact">
				<div id="contact_template" class="well">
					...
					<label>Note:</label>
					<input type="text" name="ContactPerson-#index#-Contact-Note"
