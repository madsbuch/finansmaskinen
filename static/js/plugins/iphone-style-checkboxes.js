(function() {
  ...
  iOSCheckbox = (function() {
    ...
    iOSCheckbox.prototype.wrapCheckboxWithDivs = function() {
      ...
      this.uncheckedLabel = this.elem.attr('data-uncheckedLabel') ?
          this.elem.attr('data-uncheckedLabel') : this.uncheckedLabel;
      this.checkedLabel = this.elem.attr('data-checkedLabel') ?
          this.elem.attr('data-checkedLabel') : this.checkedLabel;
