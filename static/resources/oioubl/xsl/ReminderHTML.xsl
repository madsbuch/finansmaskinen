			...
			<body>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
					<tr class="UBLReminderLineHeader">
						...
						<td>
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='ReminderInvoiceDate']"/></b>
						</td>
						<td>
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='ReminderInvoiceNumber']"/></b>
						</td>
						<td>
