		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
							...
							<xsl:if test="cac:AccountingSupplierParty !=''">
								<xsl:if test="cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID != cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID">
									<xsl:if test="cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name != cac:SellerSupplierParty/cac:Party/cac:PartyName/cbc:Name">
										<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AccountingSupplierOrd']"/></b>
										<br/>
					...
					<tr>
						<td width="26%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='OrderResponseID']"/>&#160;</b>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="2">
					<tr>
						...
						<td width="15%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AcceptedIndicator']"/></b>
						</td>
						<td width="40%">
							<b><xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='RejectionNote']"/></b>
						</td>
					</tr>
					<tr>
						...
						<td>
							<xsl:choose>
								<xsl:when test="cbc:AcceptedIndicator = 'true'">
									<xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AcceptedIndicatorTrue']"/>
								</xsl:when>
								<xsl:when test="cbc:AcceptedIndicator = 'false'">
									<xsl:value-of select="$moduleDoc/module/document-merge/g-funcs/g[@name='AcceptedIndicatorFalse']"/>
								</xsl:when>
							</xsl:choose>
						</td>
						<td>
